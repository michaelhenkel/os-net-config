...
class TestIfcfgNetConfig(base.TestCase):
    ...
    def test_add_contrail_vrouter_interface(self):
        addresses = [objects.Address('10.0.0.30/24')]
        cvi = objects.ContrailVrouterInterface('vhost0', addresses=addresses,
                                               bind_int='eth1')
        self.provider.add_contrail_vrouter_interface(cvi)
        self.assertEqual(
            _CONTRAIL_VROUTER_IFACE,
            self.provider.contrail_vrouter_interface_data['vhost0'])
